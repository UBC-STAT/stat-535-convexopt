...
* Try the examples again without the help of your classmates. 

* Read the examples at the end of the chapters. Try the exercises.
...
4. Ask your classmates. In order to ask most effectively, you should probably provide them some idea of how the error happened. See the section on [MWEs](#minimal-working-examples) for how to do this.
